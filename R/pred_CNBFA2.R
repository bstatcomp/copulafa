#' Predict from CNBFA2 model
#'
#' This function predicts based on the estimation of the CNBFA2
#' model \code{train_CNBFA2}.
#'
#' @export
...
#' @seealso \code{\link{train_CNBFA2}}
pred_CNBFA2 <- function (tr_fa, gp_test, test, logl = TRUE) {
